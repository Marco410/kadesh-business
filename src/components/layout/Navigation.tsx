...
const NICHE_DROPDOWN_LINKS: NicheDropdownLink[] = Object.entries(
      ...
      >
        ...
        <div className="hidden lg:flex items-center gap-6">
          ...
          <Link
            ...
            onClick={(e) =>
              handleLinkClick(e, Routes.home, Routes.navigation.kadeshAi)
            }
            className="ai-urim-fill inline-flex items-center rounded-full px-3 py-1 text-sm font-semibold shadow-[0_6px_16px_rgba(139,92,246,0.35)] transition-opacity hover:opacity-90 hover:text-white"
          >
            Kadesh AI
          </Link>
          ...
          <FontSizeSlider tone={atTopLight ? "onLight" : "onDark"} />
            ...
            <div className="relative" ref={avatarDropdownRef}>
              ...
              >
                {user.profileImage?.url ? (
                  ...
                  <span
                    className={`font-semibold text-sm ${atTopLight ? "text-gray-800" : "text-white"}`}
                  >
            ...
            >
              <div className="p-8">
                <div className="flex justify-between items-center mb-12">
                  <h2 className="text-white dark:text-white text-2xl font-bold">
                    KADESH
                  </h2>
                  <div className="flex items-center gap-4">
                    <FontSizeSlider tone="onDark" />
                  ...
                  <Link
                    ...
                    onClick={(e) =>
                      handleLinkClick(
                        e,
                        Routes.home,
                        Routes.navigation.kadeshAi,
                      )
                    }
                    className="ai-urim-fill text-lg font-semibold no-underline py-4 px-4 rounded-xl hover:opacity-90 hover:text-white transition-opacity"
                  >
                    Kadesh AI
                  </Link>
