          ...
          <>
            ...
            >
              ...
              >
                ...
                <div className="flex-1 overflow-y-auto min-h-0 px-6 py-4 space-y-3 bg-[#f5f5f5] dark:bg-[#161616]">
                ...
                <div className="p-4 border-t border-[#e0e0e0] dark:border-[#3a3a3a] flex items-end gap-2">
                  <textarea
                    value={draft}
