  ...
  return (
    <AnimatePresence>
      ...
      <motion.div
        ...
        className="fixed inset-0 z-[125] flex items-center justify-center p-4 pointer-events-none overflow-y-auto py-8"
      >
        <div
          className="pointer-events-auto w-full max-w-5xl max-h-[min(92vh,900px)] flex flex-col rounded-2xl border border-[#e0e0e0] dark:border-[#3a3a3a] bg-white dark:bg-[#1e1e1e] shadow-2xl overflow-hidden my-auto"
