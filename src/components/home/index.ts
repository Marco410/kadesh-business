...
export { default as WhyKadeshSection } from './WhyKadeshSection';
export { default as LeadCostComparisonSection } from './LeadCostComparisonSection';
...
// Legacy sections (kept for backwards compatibility, not used on homepage)
