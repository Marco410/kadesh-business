export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "No. Antes de agregar un negocio a tu cuenta, el sistema verifica si ya lo tienes registrado. Si el negocio ya existe, no se vuelve a agregar ni consume tu cuota mensual. Así cada crédito se usa en prospectos nuevos y tu lista crece sin duplicados mes a mes.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Sí, en el plan Agencia. Puedes asignar prospectos a miembros del equipo, registrar actividades comerciales y seguir oportunidades dentro del CRM. También controlas comisiones y espacios de trabajo, pensado para agencias y equipos que prospectan para varias cuentas a la vez.",
  },
  {
    question: "¿Qué pasa cuando alcanzo el límite de leads de mi plan?",
    answer:
      "Cuando llegas al límite mensual puedes esperar al siguiente ciclo de facturación o cambiar a un plan superior. También existen paquetes de créditos extra (250, 1,000 o 3,000) si necesitas más capacidad en el mismo mes sin subir de plan de forma permanente.",
  },
  {
    question: "¿Puedo cancelar mi suscripción en cualquier momento?",
    answer:
      "Sí. Puedes cancelar cuando quieras contactando a soporte. No hay contratos forzosos ni penalizaciones por baja. La prueba de 7 días incluye 50 leads y no pide tarjeta, así evalúas el flujo de extracción y el CRM antes de elegir un plan de pago.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Sí. El programa de referidos paga comisión por el primer pago de quien invites y recurrentes mientras esa cuenta siga activa. Al registrarte obtienes un enlace y un código para compartir. Está pensado para agencias, freelancers y partners que ya recomiendan herramientas de prospección.",
  },
  {
